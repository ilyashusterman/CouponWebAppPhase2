...
private javax.swing.JButton ok;
	...
	public static CustomerDetails getCompanyDetails(CustomerFacadeDB customer) {
		if (customerDetails == null) {
			return customerDetails = new CustomerDetails(customer);
		} else {
	...
	private CustomerDetails(CustomerFacadeDB customer) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CustomerDetails.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
    ...
    private void initComponents() {
        ...
        try {
			compDetail.setText("The Customer profile details : "+customer.getTheCustomer());
